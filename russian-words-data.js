...
const russianWords = [
    ...
    { ar: 'Сестра', ok: 'Sestra', tr: 'Kız Kardeş', s: 3, e: '👩' },
    ...
    { ar: 'Розовый', ok: 'Rozovıy', tr: 'Pembe', s: 4, e: '💗' },
    ...
    { ar: 'Одиннадцать', ok: 'Odinnadtsat', tr: 'On bir', s: 2, e: '1️⃣1️⃣' },
    { ar: 'Двенадцать', ok: 'Dvenadtsat', tr: 'On iki', s: 2, e: '1️⃣2️⃣' },
    { ar: 'Тринадцать', ok: 'Trinadtsat', tr: 'On üç', s: 2, e: '1️⃣3️⃣' },
    { ar: 'Четырнадцать', ok: 'Çetırnadtsat', tr: 'On dört', s: 2, e: '1️⃣4️⃣' },
    { ar: 'Пятнадцать', ok: 'Pyatnadtsat', tr: 'On beş', s: 2, e: '1️⃣5️⃣' },
    { ar: 'Шестнадцать', ok: 'Şestnadtsat', tr: 'On altı', s: 2, e: '1️⃣6️⃣' },
    { ar: 'Семнадцать', ok: 'Semnadtsat', tr: 'On yedi', s: 2, e: '1️⃣7️⃣' },
    { ar: 'Восемнадцать', ok: 'Vosemnadtsat', tr: 'On sekiz', s: 2, e: '1️⃣8️⃣' },
    { ar: 'Девятнадцать', ok: 'Devyatnadtsat', tr: 'On dokuz', s: 2, e: '1️⃣9️⃣' },
    { ar: 'Двадцать', ok: 'Dvadtsat', tr: 'Yirmi', s: 2, e: '2️⃣0️⃣' },
